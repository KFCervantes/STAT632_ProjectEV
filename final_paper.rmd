...
The next assumption that was checked was normality of residuals. From figure 2, it appears that normality of the residuals is satsified. In order to check, a Shapiro-Wilk normality test was used. This yielded test statistic $W = 0.97628$ and $p$-value $0.02778$. The $p$-value is significant for $\alpha = 0.05$, but not for $\alpha = 0.01$. Since the test statsistic is also larger than $0.95$, the normality condition seems satisfied.
